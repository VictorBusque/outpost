...
matches the live ``~/.local/share/sow/generated/`` tree. The apply loop then
...
from sow.engine.ports import allocate_all
...
def stage(config: sowConfig, root: str | Path, tunnel: str | None = None) -> StagedTree:
